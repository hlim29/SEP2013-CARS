    ...
    <div class="tab-content">
        <div class="tab-pane fade in active" id="tab1" >
			...
			<tr>
				...
				<td>
					<input type="text" name="lname" placeholder="Surname" value="<?php
			...
			<tr>
				...
				<td>
					<input type="text" name="pcode" placeholder="Postcode" value="<?php
			...
			<tr>
				...
				<td>
					<input type="date" name="dob" placeholder="Date of Birth" value="<?php
			echo $empData->DOB;
			?>">
				</td>    
			</tr>
